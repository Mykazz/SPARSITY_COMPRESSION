...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--fisher_power", type=float, default=1.0,
                        help="Power applied to normalized Fisher before projection. <1 compresses noisy Fisher spikes; 1.0 is old behavior.")
    parser.add_argument("--fisher_blend_magnitude", type=float, default=0.0,
                        help="Blend pure magnitude score into Fisher score. 0.05 means 5% magnitude + 95% Fisher.")
    parser.add_argument("--fisher_max_factor", type=float, default=1.0e6,
                        help="Cap normalized Fisher at this factor before top-k projection. Lower values such as 100-1000 are safer at high sparsity.")
    parser.add_argument(
